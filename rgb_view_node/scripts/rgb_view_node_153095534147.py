...
class RGB_subscriber:
    ...
    def main(self):
        camera_1 = rospy.init_node("rgb_view_node_" + DEVICE_SERIAL_036799143547)
        camera_2 = rospy.init_node("rgb_view_node_" + DEVICE_SERIAL_153095534147)
        self.rgb_sub_036799143547 = rospy.Subscriber("/kinect2_" + DEVICE_SERIAL_036799143547 + "/sd/image_color_rect",
                         Image, self.callback)
        self.rgb_sub_153095534147 = rospy.Subscriber("/kinect2_" + DEVICE_SERIAL_153095534147 + "/sd/image_color_rect",
                         Image, self.callback)
